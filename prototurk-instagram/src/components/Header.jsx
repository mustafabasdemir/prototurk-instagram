            ...
            <button>
              <a href="#">
                <li class="pl-3 flex">
                  ...
                  <p class="ml-4  text-[16px] font-sans">Página inicial</p>
                </li>
              </a>
            </button>
          </div>
          <div class="flex cursor-pointer rounded-3xl py-2 active:font-semibold hover:bg-gray-50 hover:bg-opacity-10">
            <button>
              <li class="pl-3 flex">
                ...
                <p class="ml-4 font-sans text-[16px]">Pesquisa</p>
              </li>
            </button>
          </div>
          <div class="flex cursor-pointer rounded-3xl py-2 active:font-semibold hover:bg-gray-50 hover:bg-opacity-10">
            <button>
              <li class="pl-3 flex">
                ...
                <p class="ml-4 font-sans text-[16px]">Explorar</p>
              </li>
            </button>
          </div>
          <div class="flex cursor-pointer rounded-3xl py-2  active:font-semibold hover:bg-gray-50 hover:bg-opacity-10">
          ...
          <div class="flex cursor-pointer rounded-3xl py-2 active:font-semibold hover:bg-gray-50 hover:bg-opacity-10 ">
            <button>
              <li class="pl-3 flex">
                ...
                <p class="ml-4 font-sans text-[16px]">Criar</p>
              </li>
            </button>
          </div>
...
profıl kullanıcı resmı hep aynı  
home hep aynı gonderı yok şeklinde ayarla  
ustbarı kenara al 
